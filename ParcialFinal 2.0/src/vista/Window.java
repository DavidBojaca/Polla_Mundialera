...
public class Window extends JFrame{
    ...
    private JButton botonCrear = new JButton("Crear usuario"); 
    ...
    public void initComponents() {
        ...
        this.botonCrear.setBounds(1170,700, 200, 30);
        botonCrear.setFont(new Font("Helvetivca", Font.PLAIN, 18));
        botonCrear.setForeground(Color.BLACK);
        this.add(botonCrear);

        this.botonIngresar.setBounds(1170,600, 200, 30);
        botonIngresar.setFont(new Font("Helvetivca", Font.PLAIN, 18));
    ...
    public void setController(Controller control) {
        ...
        this.botonCrear.setActionCommand(Utils.CREAR);
        this.botonCrear.addActionListener(this.control);
        this.botonIngresar.setActionCommand(Utils.INGRESAR);
        this.botonIngresar.addActionListener(this.control);
